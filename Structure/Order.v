...
Definition isom (R A S B: J) :=  ∃ f, f ∈ A ↦ᵇ B ∧ 
...
(*Proof.*)
  ...
  (*{ intros _.*)
    ...
    (*pose (eq_cl (λ s, x ∈ s) P3 (dom_i _ _ _ P9)) as P10.*)
...
Proof.
  ...
  + split.
    - intros x y P5 P6 P7.
      apply P3.
      * apply (fval_codom _ _ _ _ (bij_fmap _ _ _ P4) P5).
      * apply (fval_codom _ _ _ _ (bij_fmap _ _ _ P4) P6).
      * destruct (bij_e _ _ _ P1) as [_ P8].
        pose (eq_cr (λ s, x ∈ s) (bij_ran _ _ _ P1) P5) as P9.
        pose (eq_cr (λ s, y ∈ s) (bij_ran _ _ _ P1) P6) as P10.
        apply (eq_cr (λ s, ⟨s, _⟩ ∈ S) (inv_fval_cancel2 _ _ _ _ P8 P9)).
        apply (eq_cr (λ s, ⟨_, s⟩ ∈ S) (inv_fval_cancel2 _ _ _ _ P8 P10)).
        apply P7.
    - intros x y P5 P6 P7.
      destruct (bij_e _ _ _ P1) as [_ P8].
      pose (eq_cr (λ s, x ∈ s) (bij_ran _ _ _ P1) P5) as P9.
      pose (eq_cr (λ s, y ∈ s) (bij_ran _ _ _ P1) P6) as P10.
      apply (eq_cl (λ s, ⟨s, _⟩ ∈ S) (inv_fval_cancel2 _ _ _ _ P8 P9)).
      apply (eq_cl (λ s, ⟨_, s⟩ ∈ S) (inv_fval_cancel2 _ _ _ _ P8 P10)).
      apply P2.
      * apply (fval_codom _ _ _ _ (bij_fmap _ _ _ P4) P5).
      * apply (fval_codom _ _ _ _ (bij_fmap _ _ _ P4) P6).
      * apply P7.
...
Proof.
  ...
  + split.
    - intros x y Q1 Q2 Q3.
      pose (comp_dom_fmap _ _ _ _ _ (bij_fmap _ _ _ P1) (bij_fmap _ _ _ P4))
        as Q4.
      pose (eq_cr (λ s, x ∈ s) Q4 Q1) as Q5.
      pose (eq_cr (λ s, y ∈ s) Q4 Q2) as Q6.
      pose (fval_codom _ _ _ _ (bij_fmap _ _ _ P1) Q1) as Q7.
      pose (fval_codom _ _ _ _ (bij_fmap _ _ _ P1) Q2) as Q8.
      apply (eq_cl (λ s, ⟨s, (g ∘ f)[y]⟩ ∈ T)
        (comp_fval _ _ _ (bij_fn _ _ _ P1) (bij_fn _ _ _ P4) Q5)).
      apply (eq_cl (λ s, ⟨g[f[x]], s⟩ ∈ T)
        (comp_fval _ _ _ (bij_fn _ _ _ P1) (bij_fn _ _ _ P4) Q6)).
      apply (P5 _ _ Q7 Q8).
...
Proof.
  ...
  { apply (eq_cl (λ s, _ ∈ s) (bij_dom _ _ _ P2)).
    apply (eq_cl (λ s, _ ∈ s) (inv_ran f)).
    apply fval_ran.
    + apply inv_fn.
      apply (bij_sing_rot _ _ _ P2).
    + apply (eq_cr (λ s, x ∈ s) (inv_dom f)).
      apply (eq_cr (λ s, x ∈ s) (bij_ran _ _ _ P2)).
      apply P5. }
  destruct (bij_e _ _ _ P2) as [_ P7].
  pose (eq_cr (λ s, x ∈ s) (bij_ran _ _ _ P2) P5) as P8.
  pose (eq_cr (λ s, ⟨s, s⟩ ∈ S) (inv_fval_cancel2 _ _ _ _ P7 P8) P6) as P9.
  apply (P1 (f⁻¹[x])).
  + apply Q1.
  + apply (P4 _ _ Q1 Q1).
    apply P9.
...
Proof.
  ...
  pose (P1 _ _ _
    (fval_codom _ _ _ _ (bij_fmap _ _ _ P5) Q1)
    (fval_codom _ _ _ _ (bij_fmap _ _ _ P5) Q2)
    (fval_codom _ _ _ _ (bij_fmap _ _ _ P5) Q3) P8 P9) as P10.
...
Proof.
  ...
  destruct (isom_s _ _ _ _ P2) as [f [P3 [P4 P5]]].
  destruct (P1 _ _ 
    (fval_codom _ _ _ _ (bij_fmap _ _ _ P3) Q1)
    (fval_codom _ _ _ _ (bij_fmap _ _ _ P3) Q2))
    as [[S1 [S2 S3]]|[[S1 [S2 S3]]|[S1 [S2 S3]]]].
  + left.
    repeat split.
    - apply (P5 _ _ Q1 Q2 S1).
    - intros S4.
      apply S2.
      apply (eq_cr (λ x, f[x] = f[y]) S4 (eq_r _)).
    - intros S4.
      apply S3.
      apply (P4 _ _ Q2 Q1 S4).
  + right. left.
    repeat split.
    - intros S4.
      apply S1.
      apply (P4 _ _ Q1 Q2 S4).
    - apply ((bij_sing_rot _ _ _ P3) _ _ (f[x])).
      * apply (fval_i2 _ _ (bij_fn _ _ _ P3)).
        apply (eq_cr (λ s, x ∈ s) (bij_dom _ _ _ P3) Q1).
      * apply (eq_cr (λ s, ⟨y, s⟩ ∈ f) S2).
        apply (fval_i2 _ _ (bij_fn _ _ _ P3)).
        apply (eq_cr (λ s, y ∈ s) (bij_dom _ _ _ P3) Q2).
    - intros S4.
      apply bot_e.
      apply S3.
      apply (P4 _ _ Q2 Q1 S4).
  + right. right.
    ...
    - intros S4.
      apply S2.
      apply (eq_cr (λ x, f[x] = f[y]) S4).
      apply eq_r.
    - apply (P5 _ _ Q2 Q1 S3).
Qed.

Lemma isom_least_prop: ∀ R, ∀ A, ∀ S, ∀ B, least_prop R A → isom R A S B 
  → least_prop S B.
Proof.
  intros R A S B P1 [f [P2 [P5 P6]]] C P3 P4.
  assert (f⁻¹⟦C⟧ ⊆ A) as Q1.
  { apply (eq_cl (λ x, f⁻¹⟦C⟧ ⊆ x) (bij_dom _ _ _ P2)).
    apply inv_image_ran. }
  assert (f⁻¹⟦C⟧ ≠ ∅) as Q2.
  { destruct (nempty_ex _ P4) as [x Q2].
    ...
    + apply fval_i2.
      ...
      - apply (eq_cr (λ y, x ∈ y) (inv_dom f)).
        apply (eq_cr (λ y, x ∈ y) (bij_ran _ _ _ P2)).
        apply (P3 _ Q2).
    + apply Q2. }
  ...
  + destruct (image_e _ _ _ Q3) as [y [Q5 Q6]].
    apply (eq_cr (λ x, x ∈ C) (fval_i _ _ _ (bij_fn _ _ _ P2) (inv_e _ _ _ Q5))).
    apply Q6.
  + intros y P12.
    assert (f⁻¹[y] ∈ f⁻¹⟦C⟧) as P13.
    { apply image_i2.
      + apply inv_fn.
        apply (bij_sing_rot _ _ _ P2).
      + apply (eq_cr (λ x, y ∈ x) (inv_dom f)).
        apply (eq_cr (λ x, y ∈ x) (bij_ran _ _ _ P2)).
        apply (P3 _ P12).
      + apply P12. }
    destruct (bij_e _ _ _ P2) as  [_ P10].
    destruct (Q4 _ P13) as [Q5 | Q5].
    - left.
      assert (y ∈ ran(f)) as Q6.
      { apply (eq_cr (λ x, y ∈ x) (bij_ran _ _ _ P2)).
        apply (P3 _ P12). }
      apply (eq_cl (λ y, f[x] <[S] y) (inv_fval_cancel2 _ _ _ _ P10 Q6)).
      apply P5.
      * apply (eq_cl (λ y, x ∈ y) (bij_dom _ _ _ P2)).
        destruct (image_e _ _ _ Q3) as [s [Q8 _]].
        apply (dom_i _ _ _ (inv_e _ _ _ Q8)).
      * apply (eq_cl (λ x, (inv f)[y] ∈ x) (bij_dom _ _ _ P2)).
    ...
    - right.
      ...
      apply (inv_fval_cancel2 _ _ _ _ P10).
      apply (eq_cr (λ x, y ∈ x) (bij_ran _ _ _ P2)).
      apply (P3 _ P12).
Qed.
...
Lemma isom_bij_ex_rel: ∀ R, ∀ A, ∀ B, ∀ F, F ∈ A ↦ᵇ B
  ...
  + exists F.
    ...
    - split.
      * intros x y Q1 Q2 Q3.
        apply sub_i.
        ++apply cp_i.
          --apply (fval_codom _ _ _ _ (bij_fmap _ _ _ P1) Q1).
          --apply (fval_codom _ _ _ _ (bij_fmap _ _ _ P1) Q2).
        ++exists x.
          exists y.
          repeat split.
          --apply Q1.
